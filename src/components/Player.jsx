...
//                       transition={{ duration: 0.3 }}
//                       className={
//                         index === currentLyricIndex ? "text-yellow-300" : ""
//                       }
//                     >
//                       {line}
//                     </motion.p>
  ...
  return (
    <>
      <motion.div
        ...
        className="fixed bottom-0 left-0 right-0 bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 dark:from-purple-900 dark:via-pink-900 dark:to-red-900 backdrop-blur-lg bg-opacity-80 dark:bg-opacity-80 overflow-hidden"
      >
        <div className="container mx-auto px-4 h-full flex flex-col">
          {/* Minimized Player */}
          <div className="flex items-center justify-between h-24">
            ...
            {expanded && (
              ...
              >
                ...
                <div className="mt-8">
                  ...
                  {activeTab === "lyrics" && (
                    <div className="text-white text-center h-32 overflow-y-auto">
                      {lyrics.map((line, index) => (
                  ...
                  {activeTab === "queue" && (
                    <div className="text-white h-32 overflow-y-auto">
                      {queue.map((track, index) => (
                        <div
                          key={index}
